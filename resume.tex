...
\protected\def\google{\settoheight{\htG}{G}%
  \begin{tikzpicture}[yscale=-1,scale=(\htG/200pt),baseline=(baseline)]
...
\name{}{Muhammad Moosa Bin Naseem}

\email{moosa.binnaseem09@gmail.com}
%\homepage{atyansh.com}
\github{unh0lymos3s}
\linkedin{moosabinnaseem}
%\facebook{atyansh}
%\keybase{atyansh}
...
%\makecvfooter{\today}{Atyansh Jaiswal~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
